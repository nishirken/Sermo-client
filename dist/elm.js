...
var author$project$App$Main$Friends = function (a) {
	return {$: 'Friends', a: a};
};
var author$project$App$Main$Model = F2(
	function (user, error) {
		return {error: error, user: user};
	});
var author$project$App$Main$User = F3(
	function (id, email, friends) {
		return {email: email, friends: friends, id: id};
	});
...
var author$project$App$Main$initialModel = A2(
	author$project$App$Main$Model,
	A3(
		author$project$App$Main$User,
		0,
		'',
		author$project$App$Main$Friends(_List_Nil)),
	'');
var author$project$Auth$Common$InFormModel = F3(
	function (email, password, error) {
...
var author$project$LocalStorage$LocalStorageState = function (authToken) {
	return {authToken: authToken};
};
var author$project$LocalStorage$defaultModel = author$project$LocalStorage$LocalStorageState('');
...
var author$project$LocalStorage$modelDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$LocalStorage$LocalStorageState,
	A2(elm$json$Json$Decode$field, 'authToken', elm$json$Json$Decode$string));
var elm$json$Json$Decode$decodeString = _Json_runOnString;
var author$project$LocalStorage$decodeModel = function (value) {
	var _n0 = A2(elm$json$Json$Decode$decodeString, author$project$LocalStorage$modelDecoder, value);
	if (_n0.$ === 'Ok') {
		var x = _n0.a;
		return x;
	} else {
		return author$project$LocalStorage$defaultModel;
	}
};
...
var author$project$Routes$AuthRoute = function (a) {
	return {$: 'AuthRoute', a: a};
};
var author$project$Routes$Signin = {$: 'Signin'};
...
var author$project$Routes$matchAuthRoute = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			elm$url$Url$Parser$map,
			author$project$Routes$Signin,
...
var author$project$Routes$matchRoute = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Routes$AuthRoute, author$project$Routes$matchAuthRoute),
			A2(elm$url$Url$Parser$map, author$project$Routes$Application, elm$url$Url$Parser$top)
		]));
...
var author$project$Routes$toRoute = function (url) {
	return A2(
		elm$core$Maybe$withDefault,
		author$project$Routes$NotFound,
		A2(elm$url$Url$Parser$parse, author$project$Routes$matchRoute, url));
};
var author$project$Routes$initialModel = F2(
	function (url, key) {
		return {
			key: key,
			route: author$project$Routes$toRoute(url),
			url: url
		};
	});
...
var author$project$Main$init = F3(
	function (_n0, url, key) {
		var storageState = _n0.storageState;
		var _n1 = author$project$LocalStorage$decodeModel(storageState);
		var authToken = _n1.authToken;
		return _Utils_Tuple2(
			{
				appModel: author$project$App$Main$initialModel,
				authModel: function () {
					var model = author$project$Auth$Main$initialModel;
					return _Utils_update(
						model,
						{token: authToken});
				}(),
				isAuthorized: false,
				routesModel: A2(author$project$Routes$initialModel, url, key),
				token: authToken
			},
			elm$core$Platform$Cmd$none);
	});
var author$project$Common$errorMessage = function (error) {
	switch (error.$) {
		case 'Timeout':
		...
		case 'BadBody':
			var msg = error.a;
			return 'Error with response decoding. ' + msg;
		default:
			var code = error.a;
			return 'Something went wrong...' + (' code: ' + elm$core$String$fromInt(code));
	}
};
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								error: author$project$Common$errorMessage(httpError)
							}),
						elm$core$Platform$Cmd$none);
				}
			default:
...
var author$project$Auth$Common$DataReseived = function (a) {
...
var author$project$Auth$Common$inRequest = function (_n0) {
	var email = _n0.email;
...
var author$project$Auth$LoginForm$loginDecoder = A2(elm$json$Json$Decode$field, 'token', elm$json$Json$Decode$string);
var author$project$Common$JSONResponse = F2(
	function (data, error) {
		return {data: data, error: error};
	});
var author$project$Common$JSONError = F2(
...
var author$project$Common$errorDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Common$JSONError,
	A2(elm$json$Json$Decode$field, 'code', elm$json$Json$Decode$int),
	A2(
		elm$json$Json$Decode$field,
		'message',
		elm$json$Json$Decode$nullable(elm$json$Json$Decode$string)));
var author$project$Common$responseDecoder = function (dataDecoder) {
	return A3(
		elm$json$Json$Decode$map2,
		author$project$Common$JSONResponse,
		A2(
			elm$json$Json$Decode$field,
			'data',
			elm$json$Json$Decode$nullable(dataDecoder)),
		A2(
			elm$json$Json$Decode$field,
			'error',
			elm$json$Json$Decode$nullable(author$project$Common$errorDecoder)));
};
...
var author$project$Common$expectJsonResponse = F2(
	function (dataDecoder, data) {
		return A2(
			elm$http$Http$expectJson,
			data,
			author$project$Common$responseDecoder(dataDecoder));
	});
var author$project$Common$getJsonData = function (response) {
	if (response.$ === 'Ok') {
		var res = response.a;
		return res.data;
	} else {
...
var author$project$Common$getJsonError = function (response) {
	if (response.$ === 'Ok') {
		var res = response.a;
		return res.error;
	} else {
...
var author$project$LocalStorage$encodedModel = function (_n0) {
	var authToken = _n0.authToken;
...
var author$project$LocalStorage$setStorage = _Platform_outgoingPort('setStorage', elm$core$Basics$identity);
var author$project$LocalStorage$writeModel = function (model) {
	return author$project$LocalStorage$setStorage(
		author$project$LocalStorage$encodedModel(model));
};
...
var author$project$Auth$LoginForm$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Email':
				var email = msg.a;
			...
			case 'Send':
				return _Utils_Tuple2(
					...
					elm$http$Http$post(
						{
							body: author$project$Auth$Common$inRequest(model),
							expect: A2(author$project$Common$expectJsonResponse, author$project$Auth$LoginForm$loginDecoder, author$project$Auth$Common$DataReseived),
					...
					if (error.$ === 'Just') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									error: A2(elm$core$Maybe$withDefault, '', e.message)
								}),
							elm$core$Platform$Cmd$none);
					} else {
						...
						if (data.$ === 'Just') {
							...
							return _Utils_Tuple2(
								initModel,
								author$project$LocalStorage$writeModel(
									author$project$LocalStorage$LocalStorageState(token)));
						} else {
							return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
						}
					}
...
var author$project$Auth$SigninForm$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Email':
				var email = msg.a;
			...
			case 'Send':
				return _Utils_Tuple2(
					...
					elm$http$Http$post(
						{
							body: author$project$Auth$Common$inRequest(model),
							expect: A2(author$project$Common$expectJsonResponse, author$project$Common$successDecoder, author$project$Auth$Common$DataReseived),
...
var author$project$Routes$update = F2(
	function (msg, model) {
		if (msg.$ === 'LinkClicked') {
...
var author$project$Main$updateInnerMsg = F2(
	function (msg, model) {
		var _n0 = model;
		var authModel = _n0.authModel;
		var routesModel = _n0.routesModel;
		var appModel = _n0.appModel;
		switch (msg.$) {
			case 'RouteMsg':
				var subMsg = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							authModel: _Utils_update(
								authModel,
								{route: authRoute}),
							routesModel: updatedModel
						}),
					A2(elm$core$Platform$Cmd$map, author$project$Main$RouteMsg, updatedCmd));
			case 'AuthMsg':
				var subMsg = msg.a;
				var _n4 = A2(author$project$Auth$Main$update, subMsg, model.authModel);
				var updatedModel = _n4.a;
				var subCmd = _n4.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{authModel: updatedModel}),
					A2(elm$core$Platform$Cmd$map, author$project$Main$AuthMsg, subCmd));
			default:
				var subMsg = msg.a;
				var _n5 = A2(author$project$App$Main$update, subMsg, model.appModel);
				var updatedModel = _n5.a;
				var subCmd = _n5.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{appModel: updatedModel}),
					A2(elm$core$Platform$Cmd$map, author$project$Main$AppMsg, subCmd));
		}
	});
var author$project$Common$None = {$: 'None'};
var author$project$App$Main$outMsg = function (msg) {
	if (msg.$ === 'LogoutMsg') {
		var subMsg = msg.a;
		return subMsg;
	} else {
...
var author$project$Common$LoginSuccess = function (a) {
	return {$: 'LoginSuccess', a: a};
};
var author$project$Auth$LoginForm$outMsg = function (msg) {
	if (msg.$ === 'DataReseived') {
		var res = msg.a;
		var data = author$project$Common$getJsonData(res);
		if (data.$ === 'Just') {
			var token = data.a;
			return author$project$Common$LoginSuccess(token);
		} else {
			return author$project$Common$None;
		}
	} else {
...
var author$project$Common$SigninSuccess = {$: 'SigninSuccess'};
var author$project$Auth$SigninForm$outMsg = function (msg) {
	if (msg.$ === 'DataReseived') {
		var res = msg.a;
		var data = author$project$Common$getJsonData(res);
		if (data.$ === 'Just') {
			return author$project$Common$SigninSuccess;
		} else {
			return author$project$Common$None;
		}
	} else {
...
var author$project$Routes$updateOutCmd = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'LoginSuccess':
				return A2(
					elm$browser$Browser$Navigation$pushUrl,
					model.key,
					author$project$Routes$routeToUrl(author$project$Routes$Application));
			case 'SigninSuccess':
				return A2(
					elm$browser$Browser$Navigation$pushUrl,
					model.key,
...
var author$project$Main$updateOutCmd = F2(
	function (msg, model) {
		return elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					A2(author$project$Routes$updateOutCmd, msg, model.routesModel))
				]));
	});
var author$project$Main$updateOutModel = F2(
	function (globalMsg, model) {
		switch (globalMsg.$) {
			case 'LoginSuccess':
				var token = globalMsg.a;
				return _Utils_update(
					model,
					{token: token});
			case 'Logout':
...
var author$project$Main$updateOutMsg = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AuthMsg':
				var subMsg = msg.a;
				var msg_ = author$project$Auth$Main$outMsg(subMsg);
			...
			case 'AppMsg':
				var subMsg = msg.a;
				var msg_ = author$project$App$Main$outMsg(subMsg);
				var model_ = A2(author$project$Main$updateOutModel, msg_, model);
				return _Utils_Tuple2(
					model_,
					A2(author$project$Main$updateOutCmd, msg_, model_));
...
var author$project$Main$update = F2(
	function (msg, model) {
		var _n0 = A2(author$project$Main$updateInnerMsg, msg, model);
		var innerModel = _n0.a;
		var innerCmd = _n0.b;
		var _n1 = A2(author$project$Main$updateOutMsg, msg, innerModel);
		var outModel = _n1.a;
		var outCmd = _n1.b;
		return _Utils_Tuple2(
			outModel,
...
var author$project$App$Main$LogoutMsg = function (a) {
	return {$: 'LogoutMsg', a: a};
};
var author$project$Common$Logout = {$: 'Logout'};
var author$project$Auth$Logout$view = function (_n0) {
	return A2(
		elm$html$Html$button,
		_List_fromArray(
			[
				elm$html$Html$Events$onClick(author$project$Common$Logout)
			]),
		_List_fromArray(
			[
...
var author$project$App$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text('Application'),
				A2(
				elm$html$Html$map,
				author$project$App$Main$LogoutMsg,
				author$project$Auth$Logout$view(
					function (_n0) {
						return _Utils_Tuple0;
					}))
			]));
};
var author$project$Auth$LoginButton$view = A2(
	elm$html$Html$button,
	_List_Nil,
	_List_fromArray(
		[
...
var author$project$Auth$SigninButton$view = A2(
	elm$html$Html$button,
	_List_Nil,
	_List_fromArray(
		[
...
var author$project$Auth$Main$authButton = function (route) {
	if (route.$ === 'Login') {
		return author$project$Auth$SigninButton$view;
	} else {
		return author$project$Auth$LoginButton$view;
	}
};
var author$project$Auth$Common$Email = function (a) {
	return {$: 'Email', a: a};
};
var author$project$Auth$Common$Password = function (a) {
	return {$: 'Password', a: a};
};
var author$project$Auth$Common$Send = {$: 'Send'};
...
var author$project$Auth$Common$formInput = F3(
	function (p, v, toMsg) {
		return A2(
			elm$html$Html$input,
			_List_fromArray(
...
var author$project$Auth$Common$inFormView = F2(
	function (model, formTitle) {
		return A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(formTitle)
						])),
					A3(author$project$Auth$Common$formInput, 'email', model.email, author$project$Auth$Common$Email),
					A3(author$project$Auth$Common$formInput, 'password', model.password, author$project$Auth$Common$Password),
					A2(
					elm$html$Html$button,
					_List_fromArray(
						[
							elm$html$Html$Events$onClick(author$project$Auth$Common$Send)
						]),
					_List_fromArray(
						[
							elm$html$Html$text(formTitle)
...
var author$project$Auth$LoginForm$view = function (model) {
	return A2(author$project$Auth$Common$inFormView, model, 'Login');
};
var author$project$Auth$SigninForm$view = function (model) {
	return A2(author$project$Auth$Common$inFormView, model, 'Signin');
};
var author$project$Auth$Main$form = function (model) {
	var _n0 = model.route;
	if (_n0.$ === 'Login') {
		return A2(
			elm$html$Html$map,
			author$project$Auth$Main$LoginFormMsg,
			author$project$Auth$LoginForm$view(model.loginModel));
	} else {
		return A2(
			elm$html$Html$map,
			author$project$Auth$Main$SigninFormMsg,
			author$project$Auth$SigninForm$view(model.signinModel));
	}
};
var author$project$Auth$Main$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				author$project$Auth$Main$authButton(model.route),
				author$project$Auth$Main$form(model)
			]));
};
		...
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						function () {
						var _n1 = routesModel.route;
						switch (_n1.$) {
							case 'AuthRoute':
								return A2(
									elm$html$Html$map,
									author$project$Main$AuthMsg,
									author$project$Auth$Main$view(authModel));
							case 'Application':
								return A2(
									elm$html$Html$map,
									author$project$Main$AppMsg,
									author$project$App$Main$view(appModel));
							default:
								return A2(
									elm$html$Html$div,
									_List_Nil,
...
var author$project$Routes$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var author$project$Routes$UrlChanged = function (a) {
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		onUrlChange: function (url) {
			return author$project$Main$RouteMsg(
				author$project$Routes$UrlChanged(url));
		},
		onUrlRequest: function (urlReq) {
			return author$project$Main$RouteMsg(
				author$project$Routes$LinkClicked(urlReq));
		},
